...
$details = array();
foreach($update_data_list as $data)
{
	$details = $data;
}
?>
	...
	<div class="col s12 card pad-lg">
		...
		<form method="POST" id="admin_training_form">
				...
				<div class="col s12">
					<div class="input-field">
						...
						<select name="training_id">
							<option value="<?php echo $details->training_id; ?>" selected><?php echo $details->training_id; ?></option>
			...
			<div class="row">
				<div class="col s12">
					<div class="input-field">
						<input type="text" name="anouncement" id="anouncement" value="<?php echo $details->anouncement; ?>" class="validate">
