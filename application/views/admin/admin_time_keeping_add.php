...
<div class="row">
  ...
  <div class="col s2">
    <div class="input-field ">
      <span  id="email_result" name="email_result" class="helper-text" data-error="wrong" data-success="right"></span>
    </div>
  </div>

  <div class="col s3">
    <div class="input-field">
      <input id="cellphone_number" name="cellphone_number" type="text" class="validate">
